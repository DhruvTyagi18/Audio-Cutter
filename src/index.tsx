  ...
  return (
    <div className="container">
      ...
      <section id="how-it-works" className="info-section">
        ...
        <p>This app can be used to trim and/or cut audio tracks, remove audio fragments. Fade in and fade out your music easily to make the audio harmoniously.</p>
        <p>It is fast and easy to use. You can save the audio file in any format (codec parameters are configured).</p>
        <p>It works directly in the browser, no need to install any software, and is available for mobile devices.</p>
      </section>
      <section id="privacy-security" className="info-section">
